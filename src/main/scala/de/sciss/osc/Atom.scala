...
object Atom {
   ...
   object Int extends Atom {
      def decode( c: OSCPacketCodec, typeTag: SByte, b: ByteBuffer ) : Any = b.getInt()
   ...
   object Float extends Atom {
      def decode( c: OSCPacketCodec, typeTag: SByte, b: ByteBuffer ) : Any = b.getFloat()
   ...
   object Long extends Atom {
      def decode( c: OSCPacketCodec, typeTag: SByte, b: ByteBuffer ) : Any = b.getLong()
   ...
   object Double extends Atom {
      def decode( c: OSCPacketCodec, typeTag: SByte, b: ByteBuffer ) : Any = b.getDouble()
   ...
   object DoubleAsFloat extends Atom {
      def decode( c: OSCPacketCodec, typeTag: SByte, b: ByteBuffer ) : Any = b.getDouble.toFloat
   ...
   object LongAsInt extends Atom {
      def decode( c: OSCPacketCodec, typeTag: SByte, b: ByteBuffer ) : Any = b.getLong.toInt
   ...
   object String extends Atom {
      def decode( c: OSCPacketCodec, typeTag: SByte, b: ByteBuffer ) : Any = {
         val pos1	= b.position()
         while( b.get() != 0 ) {}
   ...
   /**
    * Encodes an `OSCPacket` as OSC blob (tag `b`)
    */
