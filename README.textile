...
*WARNING:* This is a highly unfinished new version. Please use the 0.23 tag for the latest working version.
...
ScalaOSC currently cross-builds against Scala 2.9.1 and 2.9.0. The repository contains a project file for Intellij IDEA 10 CE, and project files for sbt 0.10 (xsbt). Standard targets for sbt:
