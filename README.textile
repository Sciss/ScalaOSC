h2. ScalaOSC ==<small>-- version 0.23 --</small>==
...
ScalaOSC currently compiles against the Scala 2.9.0 and 2.8.1. The repository contains a project file for Intellij IDEA 10 CE, and project files for sbt. Standard targets for sbt:
